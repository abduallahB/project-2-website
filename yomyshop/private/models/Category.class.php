...
class Category
{
  ...
  public function find_by_sql($sql)
  {
    ...
    while ($record = $result->fetch_assoc()) {
      $cat_array[] =  self::instantiate($record); // this function to convert array to object
    }
    return $cat_array;
  }
...
public function delete()
{
  ...
  public function find_all() // index
  {
  ...
  public function find_by_id($id) //View
  {
    $cat_array = [];
    $sql = "SELECT * FROM category WHERE id = {$id}";
    $cat_array = self::find_by_sql($sql);
    return array_shift($cat_array); // this function to Shift an element off the beginning of array
  }
