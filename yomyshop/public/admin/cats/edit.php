...
<?php $selected = "cats";?>        // linked with includes/admin_header
...
<div class="container">
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // determine wheather the photo is updated or not, if updated take the new, if not stay with the one u have
